package com.innvc.drysister.db;
...
import com.innvc.drysister.DrySisterApp;
...
public class SisterDBHelper {
    ...
    private static SisterDBHelper   sDBHelper;
    ...
    public List<Sister> getSistersLimit(int curPage, int limit) {
        ...
        if (db != null) {
            Cursor cursor = db.query(TableDefine.TABLE_FULI, new String[]{
                            ...
                            TableDefine.COLUMN_FULI_WHO,}, null, null, null, null,
                    TableDefine.COLUMN_ID, startPos + "," + limit);
